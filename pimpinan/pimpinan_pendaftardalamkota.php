    ...
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class=" container-fluid position-relative d-flex p-0">
        <div class="navbar-nav w-100">
          ...
          <a href="pimpinan_pendaftardalamkota.php" class="nav-item nav-link active"><b>Pendaftar Dalam Kota</b></a>
          <a href="pimpinan_pendaftarluarkota.php" class="nav-item nav-link"><b>Pendaftar Luar Kota</b></a>
    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
          <h4 class="mb-0">Pendaftar Dalam Kota</h4>
        </div>
        <div class="table-responsive">
          <table class="table text-start align-middle table-bordered table-hover mb-0">
            ...
            <tbody>
              ...
              $query = mysqli_query($db, "SELECT * FROM tb_pendaftaran WHERE status='0'");
              $nomor = 0;
