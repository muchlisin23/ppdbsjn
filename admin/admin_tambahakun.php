  ...
  <div class="content">
    ...
    <div class="container-fluid pt-4 px-4">
      <div class="col-sm-12 col-xl-6">
        <form action="aksi/aksi_tambahakun.php" method="post">
          <div class="bg-secondary rounded h-100 p-4">
            ...
            <div class="form-floating mb-3">
              <input class="form-control" name="nama_pengguna" placeholder=" " required>
              <label>Nama Pengguna</label>
            </div>
            <div class="form-floating mb-3">
              <select class="form-select" name="role_akun" required>
