    ...
    <div class="container-fluid pt-4 px-4">
      <div class="col-sm-12 col-xl-6">
        <div class="bg-secondary rounded h-100 p-4">
          <h4 class="mb-4">Tambah Pertanyaan</h4>
          <form action="aksi/aksi_tambahpertanyaan.php" method="post">
          <div class="form-floating">
            <textarea class="form-control" placeholder=" " name="pertanyaan" style="height: 150px;"></textarea>
