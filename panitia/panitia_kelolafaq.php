    ...
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class=" container-fluid position-relative d-flex p-0">
        <div class="navbar-nav w-100">
          ...
          <a href="panitia_kelolafaq.php" class="nav-item nav-link active"><b>Kelola FAQ</b></a>
        ...
        <div class="table-responsive">
          <table class="table text-start align-middle table-bordered table-hover mb-0">
            ...
            <?php
              ...
              $query = mysqli_query($db, "SELECT * FROM tb_faq INNER JOIN tb_masuk ON tb_faq.id_masuk = tb_masuk.id_masuk");
              $nomor = 0;
              ...
              ?>
                <tr>
                  ...
                  <td><a href="aksi/aksi_hapusfaq.php?id_faq=<?php echo $data['id_faq']; ?>">
