    ...
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class=" container-fluid position-relative d-flex p-0">
        <div class="navbar-nav w-100">
          ...
          <a href="panitia_kelolajadwalwawancara.php" class="nav-item nav-link active"><b>Jadwal Wawancara</b></a>
    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <a href="panitia_tambahjadwalwawancara.php">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><a href="aksi/aksi_hapuswawancara.php?id_wawancara=<?php echo $data['id_wawancara']; ?>">
