    ...
    <div class="container-fluid pt-4 px-4">
      <div class="col-sm-12 col-xl-6">
        <div class="bg-secondary rounded h-100 p-4">
          <h4 class="mb-4">Jadwal Wawancara</h4>
          <form action="aksi/aksi_tambahwawancara.php" method="post">
          ...
          <div class="form-floating mb-3">
            <input type="date" class="form-control" name="tgl_wawancara" placeholder=" ">
