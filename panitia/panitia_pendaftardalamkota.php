    ...
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class=" container-fluid position-relative d-flex p-0">
        <div class="navbar-nav w-100">
          <a href="panitia_pendaftardalamkota.php" class="nav-item nav-link active"><b>Pendaftar Dalam Kota</b></a>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><a href="aksi/aksi_hapuspendaftaran.php?id_pendaftaran=<?php echo $data['id_pendaftaran']; ?>">
