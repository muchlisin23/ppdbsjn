    ...
    <div class="container-fluid pt-4 px-4">
      <div class="col-sm-12 col-xl-6">
        <div class="bg-secondary rounded h-100 p-4">
          ...
          <form action="aksi/aksi_tambahfaq.php" method="post">
          <div class="form-floating">
            <select class="form-select" name="masuk" autocomplete="off" required>
              <option value="">Pilih Pertanyaan</option>
              <?php 
              include '../koneksi.php';
              $query = mysqli_query($db, "SELECT * FROM tb_masuk");
              while ($data = mysqli_fetch_assoc($query)){
                echo"<option value='$data[id_masuk]'> $data[pertanyaan] </option>";
              }
              ?>
            </select>
          ...
          <br>
          <div class="form-floating">
            <textarea class="form-control" placeholder=" " name="jawaban" style="height: 150px;"></textarea>
