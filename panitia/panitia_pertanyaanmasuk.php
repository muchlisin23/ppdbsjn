    ...
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class=" container-fluid position-relative d-flex p-0">
        <div class="navbar-nav w-100">
          ...
          <a href="panitia_pertanyaanmasuk.php" class="nav-item nav-link active"><b>Pertanyaan Masuk</b></a>
    ...
    <div class="container-fluid pt-4 px-4">
      <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
          <h4 class="mb-0">Pertanyaan Masuk</h4>
          <a href="panitia_tambahpertanyaan.php">
        ...
        <div class="table-responsive">
          <table class="table text-start align-middle table-bordered table-hover mb-0">
            ...
            <?php
              ...
              $query = mysqli_query($db, "SELECT * FROM tb_masuk");
              $nomor = 0;
              ...
              ?>
                <tr>
                  ...
                  <td><a href="aksi/aksi_hapusmasuk.php?id_masuk=<?php echo $data['id_masuk']; ?>">
                      <button type="button" class="btn btn-sm btn-primary" onclick="return confirm('Apakah Anda Ingin Menghapus Data?')">Hapus</button></a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
