        ...
        <div class="container-fluid pt-5 px-5">
            <div class="bg-secondary rounded py-4 px-5">
                <div class="d-flex align-items-center justify-content-center mb-3">
                    <h5 class="mb-2"><i>Jadwal Wawancara</i></h5>
                </div>
                <p>Bagi pendaftar yang telah mendaftar baik secara online ataupun secara langsung ke sekolah, silahkan untuk datang ke sekolah dengan membawa berkas persyaratan yang diperlukan untuk melakukan wawancara sesuai dengan tanggal pada tabel dibawah ini.</p>
            </div>
        </div>
        <!-- Recent Sales End -->
                ...
                <div class="table-responsive">
                    <table class="table text-start align-middle table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($db, "SELECT * FROM tb_wawancara INNER JOIN tb_pendaftaran ON tb_wawancara.id_pendaftaran = tb_pendaftaran.id_pendaftaran");
                            $nomor = 0;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y', strtotime($data['tgl_wawancara'])) ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
