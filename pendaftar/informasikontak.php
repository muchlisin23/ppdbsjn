        ...
        <div class="container-fluid pt-5 pb-5 px-5">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-center mb-4">
                    <h5 class="mb-4"><i>Informasi Kontak</i></h5>
                </div>

                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a class="text-primary">Nomor Telepon Sekolah</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        <a>0711-363095</a>
                    </div>
                </div>
                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a class="text-primary">Email Sekolah</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        smasrijayanegara.plg@gmail.com
                    </div>
                </div>
                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a href="https://www.facebook.com/profile.php?id=100055774811411">Facebook</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        <a href="https://www.facebook.com/profile.php?id=100055774811411" class="text-body">
                            Smasrijayanegarapalembang
                        </a>
                    </div>
                </div>
                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a href="https://www.instagram.com/smasrijayanegarafkipunsriplg/?hl=en">Instagram</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        <a href="https://www.instagram.com/smasrijayanegarafkipunsriplg/?hl=en" class="text-body">
                            @smasrijayanegarafkipunsriplg
                        </a>
                    </div>
                </div>
                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a href="https://www.youtube.com/channel/UC5PpXPnlf4tlVWTuXS55PqA">Youtube</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        <a href="https://www.youtube.com/channel/UC5PpXPnlf4tlVWTuXS55PqA" class="text-body">
                            SMA SRIJAYA NEGARA PALEMBANG MITRA UTAMA FKIP UNSRI
                        </a>
                    </div>
                </div>
                <div class="row mb-2 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
                        <a class="text-primary">Kontak Panitia</a>
                    </div>
                    <div style="text-align:left; width:26.5%;">
                        Bapak Firman (0813-6636-1122)
                    </div>
                </div>
                <div class="row mb-4 d-flex align-items-center justify-content-center">
                    <div style="text-align:left; width:17.2%;">
