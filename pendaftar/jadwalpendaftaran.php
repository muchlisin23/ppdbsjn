...
<body>
    ...
    <div class="content" style="margin-left: 0; width:100%;">
        ...
        <div class="container-fluid pt-5 pb-5 px-5">
            <div class="bg-secondary rounded pt-4 pb-5 px-5">
                <div class="d-flex align-items-center justify-content-center mb-3">
                    <h5 class="mb-2"><i>Jadwal Pendaftaran</i></h5>
                </div>
                <div style="padding-left:6rem;">
                    <br>Penerimaan Peserta Didik Baru (PPDB) SMA Srijaya Negara Palembang dibagi menjadi 2 gelombang pendaftaran.
                    <br>Adapun terkait tanggal penerimaan sebagai berikut :
                    <ul><br>
                        <li>Gelombang I : 1 Februari s.d. 30 April 2022</li>
                        <li>Gelombang II : 1 Mei s.d. 30 Juni 2022</li>
                    </ul>
                </div>
            </div>
        </div>
